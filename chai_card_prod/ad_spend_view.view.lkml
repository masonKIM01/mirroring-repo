...
select '2021-12-01' as months, '원데이즈유' as merchant_name, '10,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '6500' as contract, '0' as CPA_done union all
  ...
  select '2022-01-01' as months, '윙잇' as merchant_name, '10,000원 캐시백' as title, 'CPA' as type, '0' as merchant_ratio, '14000' as contract, '0' as CPA_done union all
  select '2022-01-01' as months, '윙잇' as merchant_name, '15,000원 캐시백' as title, 'CPA' as type, '0' as merchant_ratio, '14000' as contract, '0' as CPA_done union all
  ...
  select '2022-01-01' as months, '위메프' as merchant_name, '4,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '1600' as contract, '0' as CPA_done
  )
      SELECT * FROM (
      SELECT
          ...
          case when table_redshift_merchant.name = '차이 체크카드' then '카드' else '간편결제' end AS "table_redshift_merchant.payment_type",
