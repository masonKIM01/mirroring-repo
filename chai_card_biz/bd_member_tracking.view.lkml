view: bd_member_tracking {
  derived_table: {
    sql: select
      ...
      left join
      (select x.*,
            case when x.name in ('KKday', '데싱디바', 'G마켓',  'SK스토아',  '설로인',  '롭스', '롯데온',  '네파', '롯데월드', '현대식품관투홈',  '한섬EQL',  '투믹스',  '크몽', '이삭토스트',  '위메프오', '크로켓',  '원데이즈유',  '오설록',  '여기어때', '모던하우스',  '엔터식스', '29cm', '얌테이블', '데일리호텔',  '야놀자',  '아워홈몰', '아모레몰', '올리브영', '캐치패션', '아몬즈',  '테스트벨리',  '보고플레이',  '화해', '바잇미',  '무신사',  '동원몰',  '스윙', '쿠쿠몰')
            then 'cloe'
            when x.name in ('에릭 요한슨 사진전','해피머니',  '짬뽕지존', '에릭요한슨사진전', '캐시비',  '프립', '티몬', '텐바이텐', '이랜드크루즈', '이니스프리',  'LG유플러스', '디코드',  '에이블리', '브랜드닭', '쏘카', '청소연구소',  '브알라아이스크림', '다노', '노아베이커리','펫프렌즈 (삭제 필요)')
                 then 'kevin'
            when x.name in ('만랩커피', '두브레인', '타이어픽', '인테이크', '와디즈',  '술담화',  '일꼬르소', '핏펫', '핏펫', '펫프렌즈', '어바웃펫', '마켓컬리', '사보텐',  '타코벨',  '달리살다', '랄라블라', 'GS프레시몰', 'GS프레시몰', '지니뮤직', '죠스떡볶이',  '니뽕내뽕', '엠플브라운',  'mmgl', '브랜디',  '젝시믹스', '뮬라웨어', 'deer', '인더웨어', '그립', '그린카')
                 then 'sammy'
