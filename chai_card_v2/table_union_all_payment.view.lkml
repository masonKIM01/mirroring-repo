view: table_union_all_payment {
  derived_table: {
    sql: select *
      ...
      union all
            ...
            select '2021-12-01' as months, '데일리호텔' as merchant_name, '8,000원 캐시백' as title, 'CPA' as type, '0' as merchant_ratio, '17000' as contract, '0' as CPA_done union all
            ...
            select '2021-12-01' as months, '설로인' as merchant_name, '15,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '10000' as contract, '0' as CPA_done union all
            select '2021-12-01' as months, '설로인' as merchant_name, '16,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '10000' as contract, '0' as CPA_done union all
            select '2021-12-01' as months, '설로인' as merchant_name, '18,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '10000' as contract, '0' as CPA_done union all
            ...
            select '2021-12-01' as months, '얌테이블' as merchant_name, '10,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '7000' as contract, '0' as CPA_done union all
            ...
            select '2021-12-01' as months, '현대백화점투홈' as merchant_name, '50% 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '5000' as contract, '0' as CPA_done union all
            select '2021-12-01' as months, '한섬EQL' as merchant_name, '20,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '10000' as contract, '0' as CPA_done union all
            ...
            select '2021-12-01' as months, '다노샵' as merchant_name, '40% 캐시백' as title, 'ROAS' as type, '0.7' as merchant_ratio, '0' as contract, '0' as CPA_done union all
            ...
            select '2021-12-01' as months, '리틀버드' as merchant_name, '20,000원 캐시백' as title, 'ROAS' as type, '1' as merchant_ratio, '0' as contract, '0' as CPA_done union all
            ...
            select '2021-12-01' as months, '이삭토스트' as merchant_name, '30% 캐시백' as title, 'ROAS' as type, '0.5' as merchant_ratio, '0' as contract, '0' as CPA_done
  ...
  measure: total_cpa_done {
    type: average
    sql: ${TABLE}.cpa_done)over(partiton by ${TABLE}.months, ${TABLE}.name  ;;
  }
