view: bd_owner {
  derived_table: {
    sql: select
      ...
      when x.type = 'ROAS' then x.merchant_ratio::decimal(3,2) * cashback_amount
      end as ad_spend
      from
      (select
      ...
      (
        ...
        select '2022-01-01' as months, '주붕샵' as merchant_name, '10,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '6500' as contract, '0' as CPA_done , 'Groot' as owner union all
        ...
        select '2022-01-01' as months, '위메프오' as merchant_name, '30% 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '1200' as contract, '0' as CPA_done , 'Cloe' as owner union all
        select '2022-01-01' as months, '위메프오' as merchant_name, '25% 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '1200' as contract, '0' as CPA_done , 'Cloe' as owner union all
        ...
        select '2022-01-01' as months, '원데이즈유' as merchant_name, '26,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '20000' as contract, '0' as CPA_done , 'Cloe' as owner union all
        ...
        select '2022-01-01' as months, '아이니유' as merchant_name, '10,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '6500' as contract, '0' as CPA_done , 'Groot' as owner union all
        ...
        select '2022-01-01' as months, '윙잇' as merchant_name, '10,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '11000' as contract, '0' as CPA_done, 'Kevin' as owner union all
        select '2022-01-01' as months, '윙잇' as merchant_name, '15,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '11000' as contract, '0' as CPA_done, 'Kevin' as owner union all
        ...
        select '2022-01-01' as months, '티몬' as merchant_name, '10% 캐시백' as title, 'ROAS' as type, '0.5' as merchant_ratio, '0' as contract, '0' as CPA_done, 'Groot' as owner union all
        ...
        select '2022-01-01' as months, '위메프' as merchant_name, '4,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '1600' as contract, '0' as CPA_done, 'Cloe' as owner union all
        select '2022-01-01' as months, '더반찬' as merchant_name, '12,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '6000' as contract, '0' as CPA_done, 'Cloe' as owner union all
        select '2022-01-01' as months, '티몬' as merchant_name, '15% 캐시백' as title, 'ROAS' as type, '0.33' as merchant_ratio, '0' as contract, '0' as CPA_done, 'Groot' as owner union all
        select '2022-01-01' as months, '아이엠택시' as merchant_name, '50% 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '8000' as contract, '0' as CPA_done, 'Gatsby' as owner union all
  select '2022-01-01' as months, '롯데슈퍼' as merchant_name, '15,000원 캐시백' as title, 'CPS' as type, '0' as merchant_ratio, '7000' as contract, '0' as CPA_done, 'MJ' as owner union all
